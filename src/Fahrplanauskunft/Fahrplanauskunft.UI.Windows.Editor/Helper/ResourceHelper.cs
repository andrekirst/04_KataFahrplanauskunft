...
namespace Fahrplanauskunft.UI.Windows.Editor.Helper
{
    /// <summary>
    ...
    public class ResourceHelper
    {
        ...
        {
            ResourceManager = new ResourceManager("Fahrplanauskunft.UI.Windows.Editor.Resources.Resources", typeof(FahrplanauskunftMainWindow).Assembly);
        }
